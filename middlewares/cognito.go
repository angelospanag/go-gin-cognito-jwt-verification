...
// CognitoAuthMiddleware verifies an incoming Cognito JWT, embedded in the request headers
...
func CognitoAuthMiddleware(requiredTokenUse string,
	...
	return func(c *gin.Context) {
		...
		// client ID created in the Amazon Cognito user pool.
		var appClientIdClaim string
		switch tokenUseClaim {
		case "id":
